...
| `Extension.lean` | `ZFC.ExtensionAxiom` | `Prelim` | ✅ Completo |
| `Existence.lean` | `ZFC.ExistenceAxiom` | `Prelim`, `Extension` | ✅ Completo |
| `Specification.lean` | `ZFC.SpecificationAxiom` | `Prelim`, `Extension`, `Existence` | ✅ Completo |
| `Pairing.lean` | `ZFC.PairingAxiom` | `Prelim`, `Extension`, `Existence`, `Specification` | ✅ Completo (2026-03-16) |
| `Union.lean` | `ZFC.UnionAxiom` | `Prelim`, `Extension`, `Existence`, `Specification`, `Pairing` | ✅ Completo |
| `PowerSet.lean` | `ZFC.PowerSetAxiom` | `Prelim`, `Extension`, `Existence`, `Specification`, `Pairing`, `Union` | ✅ Completo |
| `PowerSetAlgebra.lean` | `ZFC.PowerSetAlgebra` | `PowerSet`, `BooleanAlgebra` + anteriores | ✅ Completo |
| `OrderedPair.lean` | `ZFC.OrderedPairExtensions` | Todos los anteriores + `PowerSet` | ✅ Completo |
| `CartesianProduct.lean` | `ZFC.CartesianProduct` | `OrderedPair` + anteriores | ✅ Completo |
| `Relations.lean` | `ZFC.Relations` | `CartesianProduct` + anteriores | ✅ Completo |
| `Functions.lean` | `ZFC.Functions` | `CartesianProduct`, `Relations` + anteriores | ✅ Completo |
| `BooleanAlgebra.lean` | `ZFC.BooleanAlgebra` | `Union`, `Specification`, `Pairing`, `Extension`, `Existence`, `Prelim` | ✅ Completo |
| `BooleanRing.lean` | `ZFC.BooleanRing` | `PowerSetAlgebra` + anteriores | ✅ Completo |
| `PowerSetAlgebra.lean` | `ZFC.PowerSetAlgebra` | `PowerSet`, `BooleanAlgebra` + anteriores | ✅ Completo |
| `AtomicBooleanAlgebra.lean` | `ZFC.AtomicBooleanAlgebra` | `PowerSetAlgebra`, `SetOrder`, `SetStrictOrder` + anteriores | ✅ Completo (2026-03-24) |
| `Cardinality.lean` | `ZFC.Cardinality` | `Functions` + todos los anteriores | ✅ Completo (2026-03-16) |
| `NaturalNumbers.lean` | `ZFC.NaturalNumbers` | `Cardinality` + todos los anteriores | ✅ Completo |
| `Infinity.lean` | `ZFC.InfinityAxiom` | `NaturalNumbers` + todos los anteriores | ✅ Completo |
| `PeanoImport.lean` | `ZFC` | `NaturalNumbers`, `Infinity`, `PeanoNatLib.PeanoNatAxioms` | ✅ Completo |
| `GeneralizedDeMorgan.lean` | `ZFC.GeneralizedDeMorgan` | `PowerSetAlgebra` + anteriores | ✅ Completo |
| `GeneralizedDistributive.lean` | `ZFC.GeneralizedDistributive` | `PowerSetAlgebra` + anteriores | ✅ Completo |
| `SetOrder.lean` | `ZFC.SetOrder` | `Relations` + anteriores | ✅ Completo |
| `SetStrictOrder.lean` | `ZFC.SetStrictOrder` | `SetOrder` + anteriores | ✅ Completo |
| `Recursion.lean` | `ZFC.Recursion` | `NaturalNumbers`, `Functions`, `Relations` + anteriores | ✅ Completo |
| `NaturalNumbersAdd.lean` | `ZFC.NaturalNumbersAdd` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `PeanoNatLib.PeanoNatAdd` | ✅ Completo |
| `NaturalNumbersMul.lean` | `ZFC.NaturalNumbersMul` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `PeanoNatLib.PeanoNatMul` | ✅ Completo |
| `NaturalNumbersSub.lean` | `ZFC.NaturalNumbersSub` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `PeanoNatLib.PeanoNatSub` | ✅ Completo |
| `NaturalNumbersDiv.lean` | `ZFC.NaturalNumbersDiv` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `PeanoNatLib.PeanoNatDiv` | ✅ Completo |
| `NaturalNumbersPow.lean` | `ZFC.NaturalNumbersPow` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersMul`, `PeanoNatLib.PeanoNatPow` | ✅ Completo |
| `NaturalNumbersArith.lean` | `ZFC.NaturalNumbersArith` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersDiv`, `PeanoNatLib.PeanoNatArith` | ✅ Completo |
| `NaturalNumbersFactorial.lean` | `ZFC.NaturalNumbersFactorial` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersMul`, `PeanoNatLib.PeanoNatFactorial` | ✅ Completo |
| `NaturalNumbersGcd.lean` | `ZFC.NaturalNumbersGcd` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersDiv`, `NaturalNumbersArith` | ✅ Completo |
| `NaturalNumbersPrimes.lean` | `ZFC.NaturalNumbersPrimes` | `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersDiv`, `NaturalNumbersArith`, `NaturalNumbersGcd`, `PeanoNatLib.PeanoNatPrimes` | ✅ Completo |
| `NaturalNumbersBinom.lean` | `ZFC.NaturalNumbersBinom` | `NaturalNumbers`, `Infinity`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersFactorial`, `PeanoNatLib.PeanoNatBinom` | ✅ Completo |
| `NaturalNumbersMaxMin.lean` | `ZFC.NaturalNumbersMaxMin` | `NaturalNumbers`, `Infinity`, `PeanoImport`, `PeanoNatLib.PeanoNatMaxMin` | ✅ Completo |
| `NaturalNumbersNewtonBinom.lean` | `ZFC.NaturalNumbersNewtonBinom` | `NaturalNumbers`, `Infinity`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersPow`, `NaturalNumbersBinom`, `PeanoNatLib.PeanoNatNewtonBinom` | ✅ Completo |
| `NaturalNumbersWellFounded.lean` | `ZFC.NaturalNumbersWellFounded` | `NaturalNumbers`, `Infinity`, `PeanoImport`, `PeanoNatLib.PeanoNatWellFounded` | ✅ Completo |
| `FiniteSequences.lean` | `ZFC.FiniteSequences` | `NaturalNumbersAdd` + anteriores | ✅ Completo |
| `FiniteSets.lean` | `ZFC.FiniteSets` | `NaturalNumbers`, `Infinity` + anteriores | ✅ Completo |
| `FiniteSequencesArith.lean` | `ZFC.FiniteSequencesArith` | `NaturalNumbersMul`, `FiniteSequences`, `FiniteSets` + anteriores | ✅ Completo |
| `FiniteSequencesBridge.lean` | `ZFC.FiniteSequencesBridge` | `FiniteSequencesArith`, `NaturalNumbersPrimes` + anteriores | ✅ Completo |
| `CompleteBooleanAlgebra.lean` | `ZFC.CompleteBooleanAlgebra` | `PowerSetAlgebra`, `GeneralizedDeMorgan`, `SetOrder`, `AtomicBooleanAlgebra` + anteriores | ✅ Completo |
| `FiniteCofinite.lean` | `ZFC.FiniteCofinite` | `CompleteBooleanAlgebra`, `FiniteSets`, `NaturalNumbersAdd`, `Cardinality` + anteriores | ✅ Completo |
...
**Namespace**: `ZFC` (sub-namespace `ZFC.PeanoIsomorphism`)
...
**Abre los namespaces**: `Classical`, `ZFC.ExtensionAxiom`, `ZFC.ExistenceAxiom`, `ZFC.SpecificationAxiom`, `ZFC.PairingAxiom`, `ZFC.UnionAxiom`, `ZFC.PowerSetAxiom`, `ZFC.OrderedPairExtensions`, `ZFC.CartesianProduct`, `ZFC.Relations`, `ZFC.Functions`, `ZFC.Cardinality`, `ZFC.NaturalNumbers`
...
**Namespace**: `ZFC.NaturalNumbersSub`
...
**Namespace**: `ZFC.NaturalNumbersDiv`
...
**Namespace**: `ZFC.NaturalNumbersPow`
...
**Namespace**: `ZFC.NaturalNumbersArith`
...
**Namespace**: `ZFC.NaturalNumbersFactorial`
...
**Namespace**: `ZFC.NaturalNumbersGcd`
...
**Namespace**: `ZFC.NaturalNumbersPrimes`
...
**Namespace**: `ZFC.NaturalNumbersBinom`
...
**Namespace**: `ZFC.NaturalNumbersMaxMin`
...
**Namespace**: `ZFC.NaturalNumbersNewtonBinom`
...
**Namespace**: `ZFC.NaturalNumbersWellFounded`
...
**Namespace**: `ZFC.FiniteSets` (exportado a `ZFC`)
...
**Namespace**: `ZFC.FiniteSequencesArith` (exportado a `ZFC`)
...
**Namespace**: `ZFC.FiniteSequencesBridge` (exportado a `ZFC`)
...
**Namespace**: `ZFC.FiniteCofinite` (exportado a `ZFC`)
...
**Uso**: Ambas notaciones están disponibles con `open ZFC` (son `scoped`). No se abren en `NaturalNumbersAdd`/`NaturalNumbersMul` para evitar ambigüedad.

### 5.13 Aritmética en ω

- `add m n` - Suma en ω (`NaturalNumbersAdd.add`); requiere `open ZFC.NaturalNumbersAdd` o export
- `mul m n` - Producto en ω (`NaturalNumbersMul.mul`); requiere `open ZFC.NaturalNumbersMul` o export
...
**Namespace**: `ZFC.GeneralizedDeMorgan` (exportado a `ZFC`)
...
**Namespace**: `ZFC.GeneralizedDistributive` (exportado a `ZFC`)
**Última modificación**: 2026-03-24
...
**Namespace**: `ZFC.PeanoIsomorphism` (exportado a `ZFC`)
...
**Namespace**: `ZFC.NaturalNumbersAdd` (exportado a `ZFC`)
**Última modificación**: 2026-03-08
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `PeanoNatLib.PeanoNatAdd`
...
**Namespace**: `ZFC.NaturalNumbersMul` (exportado a `ZFC`)
**Última modificación**: 2026-03-08
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `PeanoNatLib.PeanoNatMul`
...
**Namespace**: `ZFC.NaturalNumbersSub` (exportado a `ZFC`)
...
**Namespace**: `ZFC.NaturalNumbersDiv` (exportado a `ZFC`)
**Última modificación**: 2026-03-21
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `PeanoNatLib.PeanoNatDiv`
...
**Namespace**: `ZFC.NaturalNumbersPow` (exportado a `ZFC`)
...
**Namespace**: `ZFC.NaturalNumbersArith` (exportado a `ZFC`)
**Última modificación**: 2026-03-22
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersDiv`, `PeanoNatLib.PeanoNatArith`
...
**Namespace**: `ZFC.AtomicBooleanAlgebra` (exportado a `ZFC`)
**Última modificación**: 2026-03-24
...
**Namespace**: `ZFC.NaturalNumbersFactorial` (exportado a `ZFC`)
**Última modificación**: 2026-03-24
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersMul`, `PeanoNatLib.PeanoNatFactorial`
...
**Namespace**: `ZFC.NaturalNumbersGcd` (exportado a `ZFC`)
**Última modificación**: 2026-03-24
**Dependencias**: `NaturalNumbers`, `Infinity`, `Recursion`, `PeanoImport`, `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersDiv`, `NaturalNumbersArith`
...
**Namespace**: `ZFC.NaturalNumbersPrimes` (exportado a `ZFC`)
...
**Namespace**: `ZFC.NaturalNumbersBinom` (exportado a `ZFC`)
**Última modificación**: 2026-03-25
**Dependencias**: `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersFactorial`, `PeanoNatLib.PeanoNatBinom`
...
**Namespace**: `ZFC.NaturalNumbersMaxMin` (exportado a `ZFC`)
...
**Namespace**: `ZFC.NaturalNumbersNewtonBinom` (exportado a `ZFC`)
**Última modificación**: 2026-03-26
**Dependencias**: `NaturalNumbersAdd`, `NaturalNumbersMul`, `NaturalNumbersSub`, `NaturalNumbersPow`, `NaturalNumbersBinom`, `PeanoNatLib.PeanoNatNewtonBinom`
...
**Namespace**: `ZFC.NaturalNumbersWellFounded` (exportado a `ZFC`)
**Última modificación**: 2026-03-26
**Dependencias**: `NaturalNumbers`, `Infinity`, `PeanoImport`, `PeanoNatLib.PeanoNatWellFounded`
...
*(Este módulo no exporta al namespace `ZFC`. Todas las definiciones y teoremas se acceden vía `open ZFC.FiniteSequences` o con nombre cualificado `FiniteSequences.isFinSeq`, etc.)*
...
**Namespace**: `ZFC.CompleteBooleanAlgebra` (exportado a `ZFC`)
...
- `FiniteSequences.lean` - Secuencias finitas en ZFC: functions f : n → A con n ∈ ω, 3 definiciones (`isFinSeq`, `FinSeqSet`, `appendElem`), 15 teoremas (predicado central, secuencia vacía, append, descomposición), sin exports a `ZFC`
