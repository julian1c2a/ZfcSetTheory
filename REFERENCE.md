...
**Dependencias**: `subseteq`, `SetOps.CartesianProduct`
...
**Dependencias**: `SpecSet`, `SetOps.CartesianProduct`, `fst`, `snd`
...
**Dependencias**: `SpecSet`, `SetOps.CartesianProduct`, `range`, `domain`, `fst`, `snd`
...
**Dependencias**: `SpecSet`, `SetOps.CartesianProduct`, `OrderedPair`
...
**Dependencias**: `SpecSet`, `SetOps.CartesianProduct`, `PowerSet`, `OrderedPair`, `Singleton`
...
**Dependencias**: `CSB_core`, `SpecSet`, `SetOps.CartesianProduct`, `OrderedPair`, `apply`
...
**Dependencias**: `SpecSet`, `ω`, `SetOps.CartesianProduct`, `OrderedPair`, `successor`
...
**Dependencias**: `SpecSet`, `SetOps.CartesianProduct`, `predecessor`
...
| `factorialOf_succ` | (σ n)! = n! · (σ n) | `theorem factorialOf_succ (n : U) (hn : n ∈ (ω : U)) : factorialOf (Nat.Basic.successor n) = mul (factorialOf n) (Nat.Basic.successor n)` |
...
| `factorialOf_le_succ` | n! ≤ (n+1)! | `theorem factorialOf_le_succ (n : U) (hn : n ∈ (ω : U)) : factorialOf n ∈ factorialOf (Nat.Basic.successor n) ∨ factorialOf n = factorialOf (Nat.Basic.successor n)` |
...
**Dependencias de construcción**: `SpecSet`, `PowerSet` (𝒫), `SetOps.CartesianProduct` (×ₛ), `isComputation`, `ω`
...
- `BoolAlg.Ring.lean` - Estructura de anillo booleano: SymDiff como suma, intersección como producto, leyes de asociatividad y distributividad
...
*Actualización anterior: 2026-03-08 12:00 — Proyección de Nat.Add.lean (3 def + 16 teoremas), Nat.Mul.lean (2 def + 13 teoremas), y ampliación de PeanoImport.lean (9 nuevos teoremas: toPeano_zero, toPeano_successor, recursion_transport x4, succ_mem_succ_iff, fromPeano_lt_iff, fromPeano_le_iff). Secciones 3.22, 3.23, 4.18, 4.19 añadidas. Sección 6 actualizada con exports 6.15–6.17.*
